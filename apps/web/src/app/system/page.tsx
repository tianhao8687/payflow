      ...
      <section className="mx-auto grid max-w-[1536px] gap-14 px-5 py-14 sm:px-8 sm:py-20 lg:items-center lg:px-16 lg:py-24 xl:grid-cols-[0.9fr_1.1fr] xl:gap-12">
        <div className="max-w-[680px]">
          ...
          <p className="mt-7 max-w-[590px] text-lg leading-8 text-[#555b66]">
            Web, API, PostgreSQL, Redis, BullMQ Worker, Stripe, and PayPal now
            cross explicit provider and queue boundaries. Verified webhooks are
            durable before asynchronous business-state transitions begin.
          </p>
        </div>
        <SystemFlow />
      </section>
